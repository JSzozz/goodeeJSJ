...
public class ShowAllBookingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ShowAllBookingServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Booking> bookingList = AdminBookingService.getBookingService().allBookingList(cPage, numPerPage);
