...
/**
 * Servlet implementation class BlackMemberList
 */
@WebServlet("/admin/member/blackList.do")
public class BlackMemberList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BlackMemberList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totolData=new AdminMemberService().blackMemberCount();
		...
		//이전
				...
				List<BlackMember> list=new AdminMemberService().blackMemberList(cPage, numPerpage);
