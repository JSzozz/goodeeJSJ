 ...
 *  - postsPerPage = 페이지 하나 당 보여지는 게시물(row)의 개수
...
public class Paginator {
    ...
    public Paginator(int pagesPerBlock, int postsPerPage, Long totalPostCount) {
    ...
    private Map<String, Object> getBlock(int currentPageNum,
                                              Boolean isFixed) {
    ...
    public Map<String, Object> getElasticBlock(int currentPageNum) {
        return this.getBlock(currentPageNum, false);
    }

    public Map<String, Object> getFixedBlock(int currentPageNum) {
