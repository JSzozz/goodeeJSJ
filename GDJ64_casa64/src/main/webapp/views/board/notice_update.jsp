									...
									<td>
										<div class="td-con">
											<div class="input-area">
												<input type="text" class="form-control w-50" name="title" value='<%=request.getAttribute("title")%>'>
											</div>
										</div>
									</td>
								</tr>
										...
										<div class="td-con">
											<div class="editor-wrap">
												<div id="smarteditor" class="editor-area">
													<!--에디터가 들어가는 영역입니다.-->
													<textarea name="contents" id="contents"><%=request.getAttribute("content")%></textarea>
												</div>
											</div>
										</div>
									</td>
