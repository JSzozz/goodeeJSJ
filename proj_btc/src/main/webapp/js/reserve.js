    ...
    function buildCalendar() {
        ...
        for(let day = 1 - doMonth.getDay(); daysLength >= day; day++) {
            ...
            //객실목록
            let roomList=["시원시원 룸","푸른푸른 룸","넘실넘실 룸","도란도란 룸","도롱도롱 룸","다정다감 룸","햇빛 룸","달빛 룸"];
            ...
            if(Math.sign(day) == 1 && lastDate.getDate() >= day) {
                ...
                for(let i=0;i<roomList.length;i++){
                    ...
                    divNode.setAttribute("class",toDay.getFullYear()+"-"+autoLeftPad((toDay.getMonth() + 1), 2)+"-"+autoLeftPad(day, 2)+"/"+(i+1));
