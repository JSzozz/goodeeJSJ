...
<body>
	...
	<p>원하는 화폐기호표시 : <fmt:formatNumber value="${numtest1 }"
		 type="currency" currencySymbol="^.~"/>
	<%-- <fmt:setLocale value="fr_FR"/> --%>
	<p>우루과이로 표시 : <fmt:formatNumber value="${numtest1 }" type="currency"/></p>
	...
	<h3><fmt:formatNumber value="123.1" maxFractionDigits="2"/></h3>
