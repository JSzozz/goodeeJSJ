...
<body>
	<div id="container">
		<header style="background-color:coral">
			<a href="<%=request.getContextPath() %>" style="text-decoration-line: none; color:black;"><h1> UI디자인 </h1></a>
					...
					<table>
						...
						<tr>
							<td>
								...
								<input type="button" value="회원가입" onclick="location.assign('<%=request.getContextPath() %>/member/memberenroll.do')" style="background-color:cornflowerblue">
				...
				<%} else{%>
					<table id="logged-in">
						...
						<tr>
							...
							<td>
								<input type="submit" value="로그아웃" onclick="location.replace('<%=request.getContextPath() %>/logout.do')" style="background-color:cornflowerblue">
							</td>
						</tr>
					</table>
				<%} %>
